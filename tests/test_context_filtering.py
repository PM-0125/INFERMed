...
class TestFilterContextByRelevance:
    ...
    def test_basic_filtering(self):
        ...
        filtered, metadata = filter_context_by_relevance(
            context, "warfarin + aspirin", query_context, min_relevance=0.1
        )
    ...
    def test_high_threshold_filtering(self):
        ...
        filtered, metadata = filter_context_by_relevance(
            context, "query", query_context, min_relevance=5.0  # High threshold
        )
    ...
    def test_preserve_structure(self):
        ...
        filtered, _ = filter_context_by_relevance(context, "query", query_context)
...
class TestFilterItemsByRelevance:
    ...
    def test_basic_item_filtering(self):
        ...
        filtered = _filter_items_by_relevance(
            items, query_context, "side_effect", min_relevance=0.1
        )
    ...
    def test_empty_items(self):
        ...
        filtered = _filter_items_by_relevance([], {}, "side_effect", min_relevance=0.1)
